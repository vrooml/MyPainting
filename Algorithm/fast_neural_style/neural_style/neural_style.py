...
import utils
from visdom_utils import Logger
    ...
    for e in range(args.epochs):
        ...
        for batch_id, (x, _) in enumerate(train_loader):
            ...
            if (batch_id + 1) % args.log_interval == 0:
                ...
                print(mesg)
                logger.log({'content_loss': agg_content_loss / (batch_id + 1), 'style_loss': agg_style_loss / (batch_id + 1)},
                       images={'original': logx, 'processed': logy})
